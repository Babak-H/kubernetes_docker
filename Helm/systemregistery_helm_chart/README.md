...
- Chart.yaml => this file contains general information about this chart
- values.yaml => contains default values for this chart, values will be injected to the template file

outside the chart we have:
- values folder => inside it we have values file for each deployment of the chart (dev,test,prod,..), these will replace the variables of values.yaml file that is inside the chart.
